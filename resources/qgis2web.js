...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3765',
            //extent: [-22982835.350288, -32963575.295723, 27358086.228888, 26513291.310785],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-358553.117425, 4208009.709456, 1533601.313459, 5551016.934456], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Atlas of Non-Pollen Palynomorphs</h2>';
        return titleElement;
    })(),
